...
def student_screen():
    ...
    phot_source = st.camera_input("Position your face in the center")

    if phot_source:
        Img = np.array(Image.open(phot_source))
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input('Enter yor name', placeholder='E.g. praveena pawar')
            ...
            try:
                audio_data = st.audio_input('Record a short pharse like I am present, My name is Pavan.')
                ...
                if new_name:
                    with st.spinner('Creating profile..'):
                        ...
                        if encodings:
                            ...
                            st.error('Coldnt capture your facial features for registration')
